...
> **UPGRADE WARNING**: There is a breaking change currently in master that could result in loss of data if used as an upgrade from a previous version. See [changelog](CHANGELOG.md) for more details.  The tag v1.1 can safely be used if you're not ready to deal with this change.
